...
@testset "Gauge transform" begin
    ...
    @test isapprox(norm(U[g[0, 0, 0]][1, 1] - (0.220397387839 - 0.046950436272im)), 0, atol = 1e-7)
    @test isapprox(norm(U[g[0, 0, 0]][2, 1] - (0.207291128273 - 0.299289327186im)), 0, atol = 1e-7)
