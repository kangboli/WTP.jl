...
@testset "Single WFC" begin
    ...
    @test wave_functions.k_coords == [0, 0, 0]
...
@testset "Contructing the Brillouin Zone" begin
    ...
    coordinates_kpoints = [wave_functions.k_coords for wave_functions in wave_functions_list]
    brillouin_zone = brillouin_zone_from_k_coords(coordinates_kpoints, wave_functions_basis(wave_functions_list[1]))
